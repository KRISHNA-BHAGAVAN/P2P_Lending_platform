        ...
        <div className="p-6">
          ...
          <div className="text-center mb-8">
            <div className="relative inline-block">
              <div className="w-20 h-20 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white text-2xl font-bold mb-3 overflow-hidden">
                {user?.profilePicture ? (
                  <img 
          ...
          <div className="space-y-2">
            {menuItems.map((item, index) => (
              <button
                ...
                className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg hover:bg-gray-50 transition-colors duration-200 ${item.className || 'text-gray-700'}`}
              >
                <span>{item.icon}</span>
